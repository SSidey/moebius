...
| Context Budget Design | Establishes a 300-line source-file budget and 400-line test-companion budget enforced by a ratchet cargo test, with AI-first organisation principles and a known-exceptions allowlist for five pre-existing over-budget files | [specifications/moeb/moeb.context-budget-design.md](specifications/moeb/moeb.context-budget-design.md) | active |
